...
namespace HotelAbshar.Persistence.Migrations
{
    ...
    [Migration("20210709144944_isFinallyUserHotelDiscount")]
    partial class isFinallyUserHotelDiscount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Discount.HotelDiscount", b =>
                {
                    b.Property<int>("HotelDiscountID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Discount.ProductDiscount", b =>
                {
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Discount.UserHotelDiscount", b =>
                {
                    b.Property<int>("UHD_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("HotelDiscountID");

                    b.HasIndex("UserID");

                    b.ToTable("UserHotelDiscounts");
                });

            modelBuilder.Entity("HotelAbshar.Domain.Entities.Discount.UserProductDiscount", b =>
                {
                    b.Property<int>("UPD_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("UserProductDiscounts");
                });
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Hotels.HotelComment", b =>
                {
                    ...
                    b.Property<int?>("EmployeeBehavior")
                        .HasMaxLength(10)
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Order_Cart.Order", b =>
                {
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Order_Cart.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Product.ProductComment", b =>
                {
                    b.Property<int>("CommentID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Discount.UserHotelDiscount", b =>
                {
                    b.HasOne("HotelAbshar.Domain.Entities.Discount.HotelDiscount", "HotelDiscount")
                        .WithMany()
                        .HasForeignKey("HotelDiscountID")
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Discount.UserProductDiscount", b =>
                {
                    b.HasOne("HotelAbshar.Domain.Entities.Discount.ProductDiscount", "ProductDiscount")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelAbshar.Domain.Entities.Order_Cart.OrderDetail", b =>
                {
                    b.HasOne("HotelAbshar.Domain.Entities.Order_Cart.Order", "Order")
